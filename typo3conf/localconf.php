...
$TYPO3_CONF_VARS['EXT']['extList'] = 'extbase,css_styled_content,version,tsconfig_help,context_help,extra_page_cm_options,impexp,sys_note,tstemplate,tstemplate_ceditor,tstemplate_info,tstemplate_objbrowser,tstemplate_analyzer,func_wizards,wizard_crpages,wizard_sortpages,lowlevel,install,belog,beuser,aboutmodules,setup,taskcenter,info_pagetsconfig,viewpage,rtehtmlarea,t3skin,reports,realurl,cshmanual,recycler,fluid,beko_debugster,scheduler,t3editor,devlog,t3jquery,ezbrequest,filelist,info,perm,rlmp_language_detection,piwik,func,about,feedit,opendocs,workspaces,rsaauth,saltedpasswords,zamn,mathematicians,sys_action,statictemplates,tt_news,nkwgok,pazpar2,static_info_tables';	// Modified or inserted by TYPO3 Extension Manager. Modified or inserted by TYPO3 Core Update Manager. 
$TYPO3_CONF_VARS['EXT']['extList_FE'] = 'extbase,css_styled_content,version,install,rtehtmlarea,t3skin,realurl,fluid,beko_debugster,devlog,t3jquery,ezbrequest,rlmp_language_detection,piwik,feedit,workspaces,rsaauth,saltedpasswords,zamn,mathematicians,statictemplates,tt_news,nkwgok,pazpar2,static_info_tables';	// Modified or inserted by TYPO3 Extension Manager.
