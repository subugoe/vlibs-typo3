<?php
	...
	// +----------------------------------------------------------------------+
	//
	// $Id: PEAR.php 639 2003-10-07 09:07:34Z kasper $
	//
		...
		*/
		function PEAR_Error($message = 'unknown error', $code = null,
			...
			if ($this->mode & PEAR_ERROR_CALLBACK) {
				...
				} elseif (is_array($this->callback) && sizeof($this->callback) == 2 && is_object($this->callback[0]) && is_string($this->callback[1]) && strlen($this->callback[1])) {
					@call_user_func($this->callback, $this);
				}
			}
		}
