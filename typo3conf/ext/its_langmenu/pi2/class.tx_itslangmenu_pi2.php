 ...
 */
class tx_itslangmenu_pi2 extends tslib_pibase {
	var $prefixId      = 'tx_itslangmenu_pi2';		// Same as class name
	var $scriptRelPath = 'pi1/class.tx_itslangmenu_pi2.php';	// Path to this script relative to the extension dir.
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/its_langmenu/pi2/class.tx_itslangmenu_pi2.php'])	{
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/its_langmenu/pi2/class.tx_itslangmenu_pi2.php']);
}
