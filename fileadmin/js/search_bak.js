...
$.ajax({
      ...
      data:{ record:params },
      dataType:"html",
      success:function(data){$(cell).html( data ); $(cell).prepend('<div class="store">' + store + '</div>');alert("cell: "+$(cell).html());alert("close: " + $(cell + 'div:first').html()); registerBS($(cell).children(".save"));registerDL($(cell).children(".download"));registerSW($(cell).children(".close"),$(cell).children(".store")); },
