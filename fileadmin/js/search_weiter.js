...
//test 
//var str = '<data><result>Valides XML </result></data>';
...
$.ajax({
      ...
      data:{ record:params },
      dataType:"html",
      success:function(data){$(cell).prepend('<div class="store">' + store + '</div>'); registerBS($(cell).children("record div a.save")); registerSW($(cell).find("a.close"),$(cell).children(".store")); },
