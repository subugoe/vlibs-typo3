...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
    ...
    <!-- global variable -->
    <xsl:variable name="adwBaseURL"><xsl:text>http://adwportal.sub.uni-goettingen.de</xsl:text></xsl:variable>
        ...
        <head>
            ...
            <link rel="shortcut icon">
                <xsl:attribute name="href">
                    ...
                    <xsl:text>/images/ico-home1.png</xsl:text>
                </xsl:attribute>
            </link>
	...
	<div id="face-wrapper">
		<div>
		<a id="face-logo-link" href="http://adwportal.sub.uni-goettingen.de">
<!--			<img src="xmlui/themes/Mirage/images/logo-akademie-goettingen.png"/> -->
			<span id="ds-face-logo"><xsl:text>&#160;</xsl:text></span>
		</a>
		</div>
		<div id="ds-face-logo-text"><i18n:text>xmlui.dri2xhtml.structural.repository.name</i18n:text></div>
		<div id="clear"></div>
	</div> 
    </xsl:template>
	...
	<!--                            <xsl:value-of
			...
			<xsl:text>http://http://adw-goe.de/3/ueber-uns/geschaeftsstelle/</xsl:text>
                        </xsl:attribute>
                    ...
                    <a>
                        <xsl:attribute name="href">
                            <xsl:value-of
                                    select="concat($adwBaseURL, '/impressum')"/>
